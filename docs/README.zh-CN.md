...
![MACR0VC 主工作区](../dist/pic/主界面.png)

### 输入中心

输入面板同时支持直接加载音频文件，以及输入文本后生成语音再进入当前目标音色。

![MACR0VC 输入中心](../dist/pic/输入界面.png)

### 转换完成视图

转换结束后，结果可以直接在主界面里试听、复核和继续合并导出。

![MACR0VC 转换完成视图](../dist/pic/转换完成界面.png)

### RES 归档

`RES` 面板保存历史输出、来源关联、模型上下文和清理操作。

![MACR0VC RES 归档](../dist/pic/历史结果界面.png)

### TASK 队列

`TASK` 面板展示当前任务、运行进度、输入来源和最近状态切换。

![MACR0VC TASK 队列](../dist/pic/task界面.png)
